  ...
  return (
    <div className="field" title={hint}>
      ...
      <div className="stepper">
        ...
        <span className="step-val">{value}{suffix?.includes('+') ? '' : ''}</span>
...
function SituationPanel({ title, sit, onChange, onCopyFrom, showAdvanced, setShowAdvanced }: { title: string, sit: Situation, onChange: (s: Situation) => void, onCopyFrom?: () => void, showAdvanced: boolean, setShowAdvanced: (v: boolean) => void }) {
  ...
  return (
    <div className="situation">
      ...
      <div className="panel">
        <div className="panel-title">Attacker</div>
        <div className="grid">
          <IncDec label="Attacks" value={sit.attacker.attacks} min={1} max={10} onChange={v => updAtt({ attacks: v })} />
          <SelectField label="BS" value={String(sit.attacker.bs)} options={[{ v: '2', l: '2+' }, { v: '3', l: '3+' }, { v: '4', l: '4+' }, { v: '5', l: '5+' }, { v: '6', l: '6+' }]} onChange={v => updAtt({ bs: Number(v) })} />
  ...
  return (
    <div className="app">
        ...
        <div className="topbar-inner">
          <div className="brand">
            ...
            <div>
              ...
              <p>Kill Team 2026 Shooting Calculator — work out the odds of a ranged attack</p>
            </div>
          </div>
          <nav className="nav">
      ...
      {showHelp && (
        <div className="help">
          <h3>How it works</h3>
          <p>Set your ballistic skill, attacks, weapon rules, and cover, then read the chance of damage and kills. Starred items have hovertext. Geared ⚙️ items are advanced — tick Advanced to show them.</p>
          <ul>
